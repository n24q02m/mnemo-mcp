...
async def test_apply_bundle_kg_sections(isolated_db: MemoryDB, tmp_path: Path):
    ...
    other._conn.execute(
        "INSERT INTO memories (id, content, created_at, updated_at, last_accessed) VALUES ('m1', 'mem1', '2024-01-01', '2024-01-01', '2024-01-01')"
    )
    other._conn.execute(
        "INSERT INTO memories (id, content, created_at, updated_at, last_accessed) VALUES ('m2', 'mem2', '2024-01-01', '2024-01-01', '2024-01-01')"
    )

    # 2. Add entities
    other._conn.execute(
        "INSERT INTO memory_entities (id, name, entity_type, created_at, updated_at) VALUES ('e1', 'Ent1', 'TypeA', '2024-01-01', '2024-01-01')"
    )
    other._conn.execute(
        "INSERT INTO memory_entities (id, name, entity_type, created_at, updated_at) VALUES ('e2', 'Ent2', 'TypeB', '2024-01-01', '2024-01-01')"
    )

    # 3. Add edges
    other._conn.execute(
        "INSERT INTO memory_edges (id, source_id, target_id, relation_type, created_at, memory_id) VALUES ('edge1', 'e1', 'e2', 'relates_to', '2024-01-01', 'm1')"
    )

    # 4. Add links
    other._conn.execute(
        "INSERT INTO memory_entity_links (memory_id, entity_id) VALUES ('m1', 'e1')"
    )
    other._conn.execute(
        "INSERT INTO memory_entity_links (memory_id, entity_id) VALUES ('m2', 'e2')"
    )
    ...
    # Verify DB state
    ents = isolated_db._conn.execute(
    ...
    links = isolated_db._conn.execute(
        "SELECT memory_id, entity_id FROM memory_entity_links ORDER BY memory_id"
    ).fetchall()
    assert len(links) == 2
